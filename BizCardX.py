...
if SELECT == 'Home':
    st.markdown(
        'This is the App for :red[BizCardX:] Extracting Business Card Data with **OCR**.EasyOCR is an open-source optical character recognition (OCR) engine that can be used to recognize text from images.OCR is the process of converting images of text into editable and searchable text.Technologies Like **Python, SQL, Streamlit, EasyOCR** are all used here.If you Upload your Business_card with name of **:blue[BusinessCard.png]** this App extract all informations like company name, card holdername, designation, mobile number, email address, website URL and Address.It also supports multiple output formats.')
    col1, col2 = st.columns(2)
    with col1:
        image = Image.open('C:/Users/ELCOT/Desktop/57573OCR.png')
        st.image(image, caption='Extracting Business Card Data with OCR')
#  CREATING PROCESS SECTION
if SELECT == "Extraction":
    col1, col2 = st.columns(2)
    with col1:
